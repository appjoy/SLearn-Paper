...
\Procedure {UpdateStatsOnJobCompletion}{Job j}
  \State sp = j.sp  \Comment{Get j's sampling percentage.}
...
\textbf{Objective:} Calculate sampling percentage that is expected to yeild
...
past jobs to keep in record corresponding to any sampling percentage.
\textbf{$SP$ or $sp$} - this is an abbreviation to denote sampling percentage. 
\textbf{Output:} \textit{sp}, \ie the best sampling percentage to be used at
this instance.
