...
run later under SJF. \editaj{We experiment with varying the number of pilot
...
tasks for piloting.}{To address this problem, we use an adaptive algorithm for determining the
sampling percentage. Figure~\ref{fig:design:AdaptiveSamplingAlgo} shows its pseudocode.}
